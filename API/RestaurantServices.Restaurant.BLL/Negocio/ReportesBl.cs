        ...
        public async Task<string> ObtenerReporteAsync(ReporteDto reporte)
        {
            ...
            switch (reporte.IdReporte)
            {
                ...
                case 2:
                    ...
                    html = GetHtmlReporteMensual(usuario, ordenes, documentoPagos);
                    break;
                default:
